...
4. [Implementation notes](./decisions/IMPLEMENTATION_NOTES_KO.md) — What is
   actually implemented, what remains planned, and why the current architecture
   was selected.
...
8. [Production annotation guide](./annotation/ANNOTATION_GUIDE_KO.md) — Queue
