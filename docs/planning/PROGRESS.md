...
- Added mirrored phase-1 documentation trees under `docs/ENG/` and `docs/KO/`
  for indexes, planning, operations, and core decisions.
- Added Korean mirrors for `PLAN`, `CONVERSATION_DATA_COLLECTION_DECISION`, and
  `TEMPORAL_GROUNDING_AND_EXPIRY_FIX`.
- Added an English mirror for `IMPLEMENTATION_NOTES`.
- Updated `docs/README.md`, `docs/ENG/README.md`, `docs/KO/README.md`, and the
  root `README.md` so they route readers through the new language-specific
  indexes.
- Explicitly kept `docs/planning/PROGRESS.md` as the English source log and
...
## 2026-09-02 - Academic goals document translated into Korean

### Completed

- Added `ACADEMIC_GOALS_AND_RESEARCH_APPROACH_KO.md` as a full Korean
  translation of the academic goals and research approach document.
- Kept the original English source file and switched the main Korean reading
  path to the translated version.
- Updated cross-document references in the docs index, root README, plan, and
  ML concepts guide.
